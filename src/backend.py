...
class Backend:
    ...
    def set_sim_config(self, vdd: float, colection_time: float, track_establishment: float, transistor_depth: float, spice: Type[SpiceRunner], path_to_dir: str) -> None:
        """
    ...
    def determine_LETs(self, delay: bool = False, report: bool = False, progress_report: Callable = None, log_circuit: bool = False):
        """
        ...
        if log_circuit: JManager.codify(self.circuit, self.circuit.path_to_circuits)
