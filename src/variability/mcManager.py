...
if __name__ == "__main__":
    ...
    with InDir("debug"):
        ...
        with open(path.join("project","circuits","nand_fin","Raw_data.csv"), "r") as file:
            ...
            assert data == [['g1', 'g1', 'fall', 'fall', 226, '01', '4.7442987080000005', '4.313604653333333'], 
                            ['g1', 'g1', 'fall', 'fall', 226, '10', '4.7442987080000005', '4.313604653333333'], 
                            ...
                            ['g1', 'g1', 'fall', 'fall', 266, '01', '4.882529028', '4.494102673333333'], 
                            ['g1', 'g1', 'fall', 'fall', 266, '10', '4.882529028', '4.494102673333333'], 
                            ...
                            ['i1', 'g1', 'fall', 'fall', 251, '10', '4.8280387000000005', '4.3524935933333335'], 
                            ['i1', 'g1', 'fall', 'fall', 266, '10', '4.882529028', '4.494102673333333'], 
                            ['i1', 'g1', 'rise', 'rise', 246, '11', '4.882529028', '4.494102673333333'], 
                            ['i1', 'g1', 'rise', 'rise', 287, '11', '4.8108', '4.372'], 
        ...
        with open(path.join("project","circuits","nand","Raw_data.csv"), "r") as file:
            ...
            assert data == [['g1', 'g1', 'fall', 'fall', 136, '01', '-0.506208021', '0.4967190959066667'],
                            ...
                            ['g1', 'g1', 'rise', 'rise', 59, '11', '-0.506208021', '0.4967190959066667'],
